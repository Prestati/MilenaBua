...
const sections = [
  { href: "/admin/hero", label: "Forside bolk 1", desc: "Endre tekst, bilde og hero-seksjonen", icon: "🖥" },
  { href: "/admin/timer", label: "Forside bolk 2", desc: "Rediger seksjon 2: Bakgrunnen / 4-timer-kortet", icon: "⏱️" },
